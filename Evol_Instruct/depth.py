base_instruction = "I want you act as a Prompt Rewriter. It is vital that you keep the same structure (with the same fields) as in the given original prompt. This MUST INCLUDE analog Choices (A) and (B) with the same format.\r\n \
